...
class DCRNNSupervisor:
    ...
    def load_model(self):
        ...
        assert os.path.exists('quantile_model/models/epo%d.tar' % self._epoch_num), 'Weights at epoch %d not found' % self._epoch_num
        
        checkpoint = torch.load('quantile_model/models/epo%d.tar' % self._epoch_num, map_location='cpu')
    ...
    def _train(self, base_lr,
        ...
        for epoch_num in range(self._epoch_num, epochs):
            ...
            val_mis, val_width, val_mse,val_rmse,val_mae,_= self.evaluate(dataset='val', batches_seen=batches_seen)
            ...
            test_mis, test_width,test_mse,test_rmse,test_mae,_= self.evaluate(dataset='test', batches_seen=batches_seen)
