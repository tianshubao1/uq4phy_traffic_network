...
if __name__ == '__main__':
    ...
    parser.add_argument('--config_filename', default='quantile_model/data/model/pretrained/METR-LA/config.yaml', type=str,
                        help='Config file for pretrained model.')
    parser.add_argument('--output_filename', default='quantile_model/data/quantile_seed0.npz')
