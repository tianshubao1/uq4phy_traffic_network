...
class EncoderModel(nn.Module, Seq2SeqAttrs):
    def __init__(self, adj_mx, **model_kwargs):
        ...
        # ----------------  pde init-----------------------------------
        self.batch_size = 256
        self.v_f = 70.65        #PEMSD8 free-speed
        self.rho_max = 0.509    #PEMSD8, rho_max,  this hyperparameter needs to be carefully chosen
        self.delta_t = 300/3600     # 5 min        
        
        PEMSD4_matrix = np.load('data/sensor_graph/PEMSD4_matrix.npy')            
        self.weight_matrix = torch.from_numpy(PEMSD4_matrix).to(device)        
...
class DecoderModel(nn.Module, Seq2SeqAttrs):
    ...
    def forward(self, inputs, batch, hidden_state=None):
        ...
        inputs = x_input_next.view(self.batch_size, size2 *self.num_nodes)        
