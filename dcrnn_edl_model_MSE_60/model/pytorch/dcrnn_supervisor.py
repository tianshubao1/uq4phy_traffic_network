...
class DCRNNSupervisor:
    ...
    def load_model(self):
        self._setup_graph()
        assert os.path.exists('dcrnn_edl_model_MSE_60/models_1/epo%d.tar' % self._epoch_num), 'Weights at epoch %d not found' % self._epoch_num
        checkpoint = torch.load('dcrnn_edl_model_MSE_60/models_1/epo%d.tar' % self._epoch_num, map_location='cpu')
