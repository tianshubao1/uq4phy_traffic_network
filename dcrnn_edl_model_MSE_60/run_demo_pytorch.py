...
if __name__ == '__main__':
    ...
    parser.add_argument('--config_filename', default='dcrnn_edl_model_MSE_60/data/model/pretrained/METR-LA/config.yaml', type=str,
                        help='Config file for pretrained model.')
    parser.add_argument('--output_filename', default='dcrnn_edl_model_MSE_60/data/edl_MSE_seed0_128.npz')
