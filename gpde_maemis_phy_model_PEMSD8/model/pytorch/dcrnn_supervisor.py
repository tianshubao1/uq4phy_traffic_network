...
class DCRNNSupervisor:
    ...
    def load_model(self):
        self._setup_graph()
        assert os.path.exists('gpde_maemis_phy_model_PEMSD8/models/epo%d.tar' % self._epoch_num), 'Weights at epoch %d not found' % self._epoch_num
        checkpoint = torch.load('gpde_maemis_phy_model_PEMSD8/models/epo%d.tar' % self._epoch_num, map_location='cpu')
