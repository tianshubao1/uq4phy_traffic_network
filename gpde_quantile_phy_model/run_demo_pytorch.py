...
if __name__ == '__main__':
    ...
    parser.add_argument('--config_filename', default='gpde_quantile_phy_model/data/model/pretrained/METR-LA/config.yaml', type=str,
                        help='Config file for pretrained model.')
    parser.add_argument('--output_filename', default='gpde_quantile_phy_model/data/gpde_quantile_phy_seed0.npz')
